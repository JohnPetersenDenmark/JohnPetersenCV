...
function ModalSelectHTMLbits({ open, onClose, title, onhandleSelected }: ModalProps) {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      await axios.get(baseUrl + '/Home/htmlsnippetlist')
        .then(response => {
          setsetHtmlSnippets(response.data);
...
export default ModalSelectHTMLbits
