...
export default function ReorderApplicationSections() {
  ...
  const handleDragStart = (e: React.DragEvent<HTMLDivElement>, id: string) => {
    ...
    let sourceDiv = e.currentTarget;
    let x = sourceDiv.parentElement;
  ...
  e.preventDefault();
    ...
    let sourceContainerDivId = null;
    const sourceContainerDiv = document.getElementById(id)?.parentElement?.parentElement?.parentElement?.parentElement
    if (sourceContainerDiv) {
      if (sourceContainerDiv.hasAttribute('id')) {
        sourceContainerDivId = sourceContainerDiv.getAttribute('id')
      }
    }

    let destinationDivId = null;
    let destDiv = null;
    if (e.currentTarget.hasAttribute('id')) {
      destinationDivId = e.currentTarget?.getAttribute('id')
      if (destinationDivId) {
        destDiv = document.getElementById(destinationDivId)
      }
    }
    ...
    if (sectionDiv) {
      if ((destinationDivId === 'keepFromPDF' && sourceContainerDivId === 'main') || (destinationDivId === 'main' && sourceContainerDivId === 'keepFromPDF')) {

        destDiv?.appendChild(sectionDiv)
